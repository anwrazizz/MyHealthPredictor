...
import com.example.myhealthpredictor.Prediction.PredictionResultActivity
import com.example.myhealthpredictor.Prediction.PredictionViewModel
...
class PredictionActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        viewModel.predictionResult.observe(this) { result ->
            ...
            intent.putExtra(PredictionResultActivity.Companion.EXTRA_RESULT, result)
